...
This book watches configured data sources, maintains analysis pages, and publishes a usable generated web tool.

Main areas:

- `wiki/methods/analysis-method.md`: operator-defined analysis method.
