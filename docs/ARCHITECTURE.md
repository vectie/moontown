...
- [visual_projection_runtime/](/Users/kq/Workspace/moontown/src/visual_projection_runtime)
  ...
  projection JSON beside town snapshots. It may load decorator manifests such
  as `src/ui/assets/tilemap/modules/wenyu-town-modules.json` and translate them
  into the generic placement contract before persistence. Runtime packages
  should call this package when they need durable UI state instead of putting
  filesystem writes into visual projection policy.
...
- [standing_watch_policy/](/Users/kq/Workspace/moontown/src/standing_watch_policy)
  ...
  `no_change` markers, or auto-triage/recovery summary wording locally.
...
content, course index content, cookbook audit state, structural path existence,
civic result existence, and exposing the runtime scorer that combines file
observation with package-owned scoring.
...
- [civic/communication_scenario_types.mbt](/Users/kq/Workspace/moontown/src/civic/communication_scenario_types.mbt)
...
- [civic/communication_metrics.mbt](/Users/kq/Workspace/moontown/src/civic/communication_metrics.mbt)
- [civic/communication_schedule_types.mbt](/Users/kq/Workspace/moontown/src/civic/communication_schedule_types.mbt)
- [civic/communication_schedule_policy.mbt](/Users/kq/Workspace/moontown/src/civic/communication_schedule_policy.mbt)
...
- `research_policy/`
  ...
  - owns reusable generated-request discovery/fallback policy text such as
